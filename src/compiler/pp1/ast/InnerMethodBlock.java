...
public class InnerMethodBlock implements SyntaxNode {
    ...
    public InnerMethodBlock (ConstructorDecl ConstructorDecl, MethodDeclList MethodDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("InnerMethodBlock(\n");
