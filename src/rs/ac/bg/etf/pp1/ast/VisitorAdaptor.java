...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(BaseDsgn BaseDsgn) { visit(); }
    ...
    public void visit(WhileCheck WhileCheck) { visit(); }
    public void visit(ElseCond ElseCond) { visit(); }
    public void visit(IfCond IfCond) { visit(); }
    public void visit(IfInit IfInit) { visit(); }
    ...
    public void visit(InitVTP InitVTP) { visit(); }
