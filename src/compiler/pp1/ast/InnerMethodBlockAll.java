...
public class InnerMethodBlockAll extends InnerMethodBlock {

    private ConstructorDecl ConstructorDecl;
    private MethodDeclList MethodDeclList;

    public InnerMethodBlockAll (ConstructorDecl ConstructorDecl, MethodDeclList MethodDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("InnerMethodBlockAll(\n");
